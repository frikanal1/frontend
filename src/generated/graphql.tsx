...
export type GetVideoQuery = { __typename?: 'Query', video: { __typename?: 'VideoQueries', get: { __typename?: 'Video', id: string, title: string, description: string, createdAt: any, duration?: number | null, organization: { __typename?: 'Organization', id: string, name: string, latestVideos?: Array<{ __typename?: 'Video', id: string, title: string, description: string, createdAt: any, duration?: number | null, organization: { __typename?: 'Organization', id: string, name: string }, images: { __typename?: 'VideoImages', thumbLarge: string, thumbMedium: string, thumbSmall: string }, assets: Array<{ __typename?: 'VideoAsset', id: string, type: string, path: string }> }> | null }, images: { __typename?: 'VideoImages', thumbLarge: string, thumbMedium: string, thumbSmall: string }, assets: Array<{ __typename?: 'VideoAsset', id: string, type: string, path: string }> } } };
...
export type LatestVideosFragment = { __typename?: 'Organization', id: string, name: string, latestVideos?: Array<{ __typename?: 'Video', id: string, title: string, description: string, createdAt: any, duration?: number | null, organization: { __typename?: 'Organization', id: string, name: string }, images: { __typename?: 'VideoImages', thumbLarge: string, thumbMedium: string, thumbSmall: string }, assets: Array<{ __typename?: 'VideoAsset', id: string, type: string, path: string }> }> | null };
...
export type GetOrganizationQuery = { __typename?: 'Query', organization: { __typename?: 'Organization', id: string, name: string, description?: string | null, homepage?: string | null, postalAddress: string, streetAddress: string, editor: { __typename?: 'OrganizationEditor', id: string, name: string, email: string }, latestVideos?: Array<{ __typename?: 'Video', id: string, title: string, description: string, createdAt: any, duration?: number | null, organization: { __typename?: 'Organization', id: string, name: string }, images: { __typename?: 'VideoImages', thumbLarge: string, thumbMedium: string, thumbSmall: string }, assets: Array<{ __typename?: 'VideoAsset', id: string, type: string, path: string }> }> | null } };
